...
REM
REM Generated by Vivado on Mon Sep 29 11:19:37 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj mainTB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mainTB_vlog.prj -log xvlog.log
